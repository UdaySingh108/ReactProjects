...
function App() {
  ...
  return (
      <div className='w-screen max-w-md mx-auto shadow-2xl rounded-lg px-4 mt-12 text-red-500 bg-gray-900'>
        ...
        <div className='flex text-sm gap-x-4 py-5 justify-center'>
          ...
          <div className='flex items-center gap-x-1'>
            <input type="checkbox"
              ...
              id = "numberInput"
              onChange = {() =>{
                setNumberAllowed((prev) => !prev); // previous value jo bhi hai use ulte kr do ttrue/false flip hota rahega 
              }}
             />
             <label>Numbers</label>
          ...
          <div className='flex items-center gap-x-1'>
            <input type="checkbox"
              ...
              id = "charInput"
              onChange = {() =>{
                setCharAllowed((prev) => !prev); // previous value jo bhi hai use ulte kr do ttrue/false flip hota rahega 
              }}
             />
